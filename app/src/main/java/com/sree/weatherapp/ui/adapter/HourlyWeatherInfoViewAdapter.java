...
/**
 * Adapter class for binding hourly weather information with view.
 * <p/>
 * {@link RecyclerView.Adapter} that can display a {@link WeatherInfo} and makes a call to the
 * specified {@link OnListFragmentInteractionListener}.
 */
public class HourlyWeatherInfoViewAdapter extends RecyclerView.Adapter<HourlyWeatherInfoViewAdapter.ViewHolder> {

    private final List<WeatherInfo> mValues;
    private final OnListFragmentInteractionListener mListener;
    private Context mContext;

    public HourlyWeatherInfoViewAdapter(List<WeatherInfo> items, OnListFragmentInteractionListener listener, Context mContext) {
        mValues = items;
        mListener = listener;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        String time = Utils.getTimeFromSeconds(mValues.get(position).getWeatherTime(), AppConstants.DateTimeConstants.DATE_TIME_PATTERN_DD_MMM_hh_mm_a);

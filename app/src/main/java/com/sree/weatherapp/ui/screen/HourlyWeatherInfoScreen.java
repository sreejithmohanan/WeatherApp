 ...
 */
@Layout(R.layout.screen_hourly_weatherinfo)
public class HourlyWeatherInfoScreen extends Path implements ScreenComponentFactory<HomeActivity.Component> {
    ...
    public interface Component extends AppDependencies {
        void inject(HourlyWeatherInfoView view);
    }

    @DaggerScope(Component.class)
    public static class Presenter extends ViewPresenter<HourlyWeatherInfoView> implements OnListFragmentInteractionListener {

        private final ApiClient restClient;

        private HourlyWeatherInfoViewAdapter adapter;
        ...
        protected void onLoad(Bundle savedInstanceState) {
            ...
            adapter = new HourlyWeatherInfoViewAdapter(weatherInfoList, this,getView().getContext());
